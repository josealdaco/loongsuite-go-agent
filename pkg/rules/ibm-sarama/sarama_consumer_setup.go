...
//go:linkname consumePartitionOnEnter github.com/IBM/sarama.consumePartitionOnEnter
func consumePartitionOnEnter(call api.CallContext, _ interface{}, topic string, partition int32, offset int64) {
}

//go:linkname consumePartitionOnExit github.com/IBM/sarama.consumePartitionOnExit
